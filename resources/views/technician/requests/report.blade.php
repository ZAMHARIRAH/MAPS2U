...
body{margin:0;padding:24px;background:#edf2f7;color:#111827;font-family:Arial,Helvetica,sans-serif}
.toolbar{width:min(100%,1120px);margin:0 auto 16px;display:flex;justify-content:flex-end;gap:10px}
.btn{padding:10px 14px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;color:#111827;text-decoration:none;font-size:14px}
.btn.primary{background:#0f172a;color:#fff;border-color:#0f172a}
.page{width:min(100%,1120px);margin:0 auto;background:#fff;padding:28px;box-shadow:0 12px 35px rgba(15,23,42,.08)}
h1{text-align:center;font-size:30px;margin:0 0 24px}
