...
.btn{padding:9px 13px;border:1px solid #cbd5e1;border-radius:10px;background:#fff;color:#111827;text-decoration:none;font-size:11px;line-height:1.2}.btn.primary{background:#0f172a;color:#fff;border-color:#0f172a}
.page{width:min(100%,1020px);margin:0 auto;background:#fff;padding:14px;box-shadow:0 10px 28px rgba(15,23,42,.08);border-radius:14px}
.report-title{text-align:center;font-size:18px;font-weight:700;margin:0 0 16px}
...
@media print{html,body{background:#fff!important;padding:0!important;margin:0!important;font-size:10px;zoom:.84;-webkit-print-color-adjust:exact;print-color-adjust:exact}.toolbar{display:none!important}.page{width:auto!important;margin:0!important;padding:0!important;box-shadow:none!important;border-radius:0!important}.box,.row,tr,td,th{break-inside:avoid;page-break-inside:avoid}}
...
<div class="page">
    ...
    <section class="box">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-card"><strong>Submission Mode</strong><span>{{ data_get($feedback, 'submission_mode') === 'agree_all' ? 'Agree All (Scale ' . (data_get($feedback, 'agree_all_scale') ?: '-') . ')' : 'Manual Form' }}</span></div>
        </div>
