...
<div class="page">
            ...
            <div class="section-list">
                ...
                @foreach($submission->requestType->questions as $question)
                    ...
                    @php($answerText = match ($question->question_type) {
                        ...
                        'radio' => trim((string) data_get($answer, 'value', '')) . (data_get($answer, 'other') ? ' - ' . data_get($answer, 'other') : ''),
    ...
    <section class="table-box">
        ...
        <div style="padding:16px;display:grid;gap:12px;">
            <div class="row"><strong>Submission Mode</strong><span>{{ data_get($feedback, 'submission_mode') === 'agree_all' ? 'Agree All' : 'Manual Form' }}</span></div>
